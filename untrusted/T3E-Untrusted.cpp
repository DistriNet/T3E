...
struct TrustedTimeHandler::Impl
{
    ...
    Impl(sgx::EnclaveHandler& enclave, SigScheme scheme): scheme(scheme), enclave(enclave)
    {
        ...
        auto [primaryHandle, primaryObject] = context.createPrimary(
            ESYS_TR_RH_ENDORSEMENT, tpm::initializer::DEFAULT_SENSITIVE_CREATE,
            getEKInitializer(scheme),
    ...
    auto createAttestationKey()
    {
        ...
        auto object =
            context.createObject(policySession, primaryHandle, tpm::initializer::DEFAULT_SENSITIVE_CREATE_AK,
                                 getAKInitializer(scheme),
                                 tpm::initializer::EMPTY_OUTSIDE_INFO, tpm::initializer::EMPTY_PCR_SELECTION);
...
TrustedTimeHandler::TrustedTimeHandler(sgx::EnclaveHandler& enclave, SigScheme scheme): impl(std::make_unique<Impl>(enclave, scheme)) {}
